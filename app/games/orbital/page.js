...
export default function OrbitalPage() {
  ...
  const upperImages = Array.from({ length: 5 }, (_, i) => `/images/Orbital/upper${i + 1}.webp`);
  const lowerImages = Array.from({ length: 5 }, (_, i) => `/images/Orbital/lower${i + 1}.webp`);
  ...
  return (
    <div className="body">
      ...
      <div className="o-banner">
        <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" fill="#81badf" fillRule="evenodd" viewBox="0 0 1000 35">
      ...
      <main className="ss-page">
        ...
        <p>
          Step into the role of planetary pilot and save the planet from being swallowed into the abyss of a black hole. Prolong the existence of the planet by utilising your planetary technologies to avoid asteroids, supernovas, neutron stars and wormholes.
          <br /><br />
        ...
        <div className="downloads">
          <Link href="https://play.google.com/store/apps/details?id=com.ClassyGamesStudios.OrbitalV2" target="_blank">
