...
export default function AboutUs() {
  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.set(".about-text-cnt", { y: 100, opacity: 0 });
      gsap.to(".about-text-cnt", {
        y: 0,
        opacity: 1,
        delay: 0.2,
        duration: 0.5,
      ...
      gsap.from(".section-title, .section-paragraph, .team-photo-cnt", {
        scrollTrigger: {
      ...
      gsap.from(".story-section .section-content", {
        scrollTrigger: {
      ...
      gsap.from(".awards-section .section-content, .awards-row", {
        scrollTrigger: {
  ...
  return (
      <div className="body">
        ...
        {/* Section 1 - Team (Light/White) */}
        <section className="team-section light-section">
        ...
        {/* Section 2 - Story & Vision (Dark) */}
        <section className="story-section dark-section">
          <div className="section-container">
            <div className="section-content">
            ...
            <div className="section-content">
              <h1 className="section-title">Our Vision & Values</h1>
              <p className="section-paragraph">
        ...
        {/* Section 3 - Awards (Light/White) */}
        <section className="awards-section light-section">
          <div className="section-container">
            <div className="section-content">
