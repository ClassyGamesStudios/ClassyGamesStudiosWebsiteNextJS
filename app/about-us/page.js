      ...
      <main className="photo-page">
        ...
        <div className="under-text">
          ...
          <p className="under-paragraph">
            Classy Games Studios was born during the early days of COVID-19, when people were isolated and looking for
            ways to connect. We started by making small, free games to help friends and strangers play together, share moments, and feel a little less alone.
            <br/><br/>
            That spirit stayed with us.
            <br/><br/>
            Our founder, Jamie McClenaghan, started Classy Games Studios with a simple belief: games should bring back that feeling of being
            a kid — curious, playful, and fully in the moment. Even as busy adults, we still need space for imagination and joy.
            <br/><br/>
            At Classy Games Studios, we build games that do just that. No bloat. No noise. Just thoughtful, polished experiences designed to spark joy.
          </p>
        </div>
        {/*<Image*/}
        {/*    src={teamImage}*/}
        ...
        <div className="under-text">
          ...
          <p className="under-paragraph">
            At Classy Games Studios, our vision is to create engaging games that ignite your imagination and bring out your inner child.
            <br /><br />
      ...
      <main className="team-page">
        ...
        <div className="under-text">
          ...
          <div className="awards-row">
            <a href="https://www.menagamesawards.com/the-winners-of-2025/" target="_blank" rel="noopener noreferrer">
              <img src="assets/Awards/MENAGameAwardFinalist_Award.webp" alt="MENAGameAwardFinalist2025Award" className="award-img"/>
            </a>
            <a href="https://meamarkets.digital/winners/classy-games-studios/" target="_blank" rel="noopener noreferrer">
              <img src="assets/Awards/UAEBusinessAwards_Award.webp" alt="UAEBusinessAward2025" className="award-img"/>
            </a>
            <a href="https://corporatelivewireglobalawards.com/global-awards/" target="_blank" rel="noopener noreferrer">
              <img src="assets/Awards/CorporateLiveWire_Award.webp" alt="CorporateLiveWire2025Award" className="award-img"/>
            </a>
            <a href="https://gamedevheroes.co" target="_blank" rel="noopener noreferrer">
              <img src="assets/Awards/GameDevHeroesAwards_Award.webp" alt="GameDevHeroes2025Award" className="award-img"/>
            </a>
          </div>
        </div>
      </main>
