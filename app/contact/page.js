      ...
      <main className='contact-page'>
            ...
            <div className=' contact-lower-cnt'>
              ...
              <div className='contact-cnt'>
                ...
                <div className='contact-info-cnt'>
                  <h2>Our Locations</h2>
                  <Link href="https://www.google.com/maps?q=Northern+Ireland+and+United+Arab+Emirates" target='_blank'>Northern Ireland & UAE</Link>
                </div>
              </div>  
            </div>
          </div>
            ...
            >
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input type="text" name="First Name" id="firstName" placeholder="ex. Mike" required />
                </div>
                <div className="form-group">
                  <label htmlFor="lastName">Last Name</label>
                  <input type="text" name="Last Name" id="lastName" placeholder="ex. Scott" required />
                </div>
              </div>
              <div className="form-group">
                <label htmlFor="email">Email</label>
                <input type="email" name="Email" id="email" placeholder="ex. email@example.com" required />
              </div>
              <div className="form-group">
                <label htmlFor="message">Message</label>
                <textarea name="Message" id="message" placeholder="Example Text" required></textarea>
              </div>

              <input type="hidden" name="_next" value="https://classygamesstudios.com/contact" />
...
<main className="map-cnt">
            ...
            <div className='map'>
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d151986.698977561!2d-5.864149942257194!3d54.671144565130604!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2s!4v1733502787462!5m2!1sen!2s"
        ...
        <div className="map">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d86533.15445741397!2d55.266033788578866!3d25.21596606905573!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2s!4v1733502574639!5m2!1sen!2s"
                        width="100%" height="400"  allowFullScreen="" loading="lazy"
                        referrerPolicy="no-referrer-when-downgrade"></iframe>
